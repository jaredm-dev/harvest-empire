...
export const PRESTIGE_CONFIG = [
  {
    ...
    requirement: 100000,
    multiplier: 1.5,
    description: '1.5× all income — unlocks Blueberries, Industrial Harvester, Semi-Truck',
  },
  {
    level: 2,
    name: 'Go National',
    ...
    requirement: 1500000,
    multiplier: 2.5,
    description: '2.5× all income — unlocks Truffles, Mega Harvester, Mega Warehouse',
  },
  {
    level: 3,
    name: 'Global Empire',
